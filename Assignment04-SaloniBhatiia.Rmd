...
# 2c -Edit The NAme
#Rost1 %>% separate(Name, into=c("FirstName", "Lastname", "Position")) # Separates the Position


ShootingStats = cbind(Rost1,Rost2)

SS <-ShootingStats %>% separate(Name, into=c("FirstName", "LastName", "Position")) # Separates the Position
...
SS %>% ggplot(aes(y=FGA, x=FirstName), fill=Position )+geom_bar(stat="identity")+ xlab("Field Goal Percentage") +ylab("Player")+ggtitle("Field Goals Percentage Per Game ")+coord_flip()
